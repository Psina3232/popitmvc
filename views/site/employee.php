<h2 class="text-center text-4xl my-12">Добавить сотрудника отдела кадров</h2>
<h3><?= $message ?? ''; ?></h3>
<form method="post" enctype="multipart/form-data" class="flex flex-col items-center max-w-xs border-2 border-blue-700 rounded-xl mx-auto mt-5 p-5 gap-2.5">
   ...
   <button class="bg-blue-500 w-60 h-10 text-white text-xl font-bold">Добавить</button>
</form>